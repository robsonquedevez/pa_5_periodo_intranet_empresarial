<?php if(!class_exists('Rain\Tpl')){exit;}?>
      ...
      <div class="modal fade" id="response" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal fade" id="modalUpdateUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
               <form id="frm-register-user-update">
                  <div class="modal-body"> 
                    ...
                    <input type="hidden" name="id" id="idUserUp">
                      ...
                      <div class="form-group">
                          ...
                          <label>Nome</label>
                          <input type="text" name="nome" id="idNomeUp" class="form-control">
                      
                          <label>Usuário</label>
                          <input type="text" name="nome" id="idUsuarioUp" class="form-control" disabled="">                      

                          <label>Departamento</label>
                          <select class="custom-select" name="departamento" id="idDepartamentoUp" class="custom-select">
                          ...
                          <label>Gestor</label>
                          <select class="custom-select" name="gestor" id="idGestorUp" class="custom-select">
                            <option value="1">Sim</option>
                            <option value="0">Não</option>
                          </select>
                          ...
                          <div class="form-row mt-3">
                            ...
                            <div class="col">
                              <input type="password" name="confirmaSenha" class="form-control" placeholder="Confirma nova senha">
                            </div>                         
